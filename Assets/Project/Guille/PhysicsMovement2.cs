...
namespace net.GuilledlC.Shooter {
	...
	public class PhysicsMovement2 : MonoBehaviour {
		...
		private void CollisionCheck() {
			...
			int num = Physics.OverlapBoxNonAlloc(collider.center, collider.size/2, overlaps);
